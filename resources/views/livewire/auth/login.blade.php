...
<div class="truthguard-auth-shell relative flex h-dvh w-full items-center justify-center overflow-hidden bg-slate-100 px-4 sm:px-6 lg:px-8">
    ...
    <div class="relative z-10 w-full max-w-md">
        <div
            ...
            class="truthguard-auth-card rounded-2xl border-2 border-slate-300 bg-white p-5 shadow-2xl shadow-slate-400/40 ring-2 ring-slate-200/70 backdrop-blur-xl sm:p-6"
        >
